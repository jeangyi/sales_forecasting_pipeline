# Project Summary
This project demonstrates a time-series forecasting pipeline for daily sales using a **CatBoost regressor** with **lag-based temporal features** and **recursive multi-step prediction**.
